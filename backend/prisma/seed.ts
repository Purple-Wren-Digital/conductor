...
import { UserRole, TicketStatus, Priority, CommentType } from "../types";
    ...
    data: [
      {
        ...
        content:
          "I keep getting an error when I try to upload the contract PDF.",
      },
      {
        id: "comment_002",
        userId: user2.id,
        ...
        content:
          "Checked the logs; seems like a file size limit issue. Looking into it.",
      },
      {
        id: "comment_003",
        userId: user1.id,
      ...
      },
      {
        ...
        content:
          "Payment should be disbursed by Friday. Waiting on one final signature.",
      },
    ],
  });
