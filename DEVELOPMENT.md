...
```bash
git remote add encore encore://conductor-ticket-system-2hbi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/conductor-ticket-system-2hbi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/conductor-ticket-system-2hbi/settings/integrations/github)
