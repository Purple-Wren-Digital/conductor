...
export default function CreateTicketPage() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:4000/tickets/${createdTicket.id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className="container max-w-2xl mx-auto py-8">
      <div className="mb-4 flex justify-end">
        <Button onClick={toggleTicketList} variant="outline">
        ...
        <Card className="mt-6">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Ticket ID: {createdTicket.id}</CardDescription>
            </div>
            {!isEditing && (
              <div className="flex flex-col gap-2">
                ...
                <Button
                  onClick={() => handleDelete(createdTicket.id)}
                  variant="outline"
                  size="sm"
                >
                  Delete Ticket
                  ...
                  <div>
                    ...
                    <p
                      className={`font-medium ${
                        createdTicket.urgency === "HIGH"
                          ? "text-red-600"
                          : createdTicket.urgency === "MEDIUM"
                            ? "text-yellow-600"
                            : "text-green-600"
                      }`}
                    >
