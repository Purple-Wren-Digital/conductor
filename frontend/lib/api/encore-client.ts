...
export namespace notifications {
    ...
    export class ServiceClient {
        ...
        public async formatStandard(templateName: string, params: templates.FormatStandardNotificationRequest): Promise<templates.FormatStandardNotificationResponse> {
            // Now make the actual call to the API
            ...
            return await resp.json() as templates.FormatStandardNotificationResponse
        }
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "conductor-ee92-Generated-TS-Client (Encore/v1.57.13)";
        }
