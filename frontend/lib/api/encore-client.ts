...
export default class Client {
    ...
    public readonly tickets: tickets.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.tickets = new tickets.ServiceClient(base)
    }
...
export namespace tickets {
    ...
    export class ServiceClient {
         ...
         */
        public async addComment(id: string, params: {
    content: string
    internal?: boolean
}): Promise<TicketComment> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/tickets/${encodeURIComponent(id)}/comments`, JSON.stringify(params))
            return await resp.json() as TicketComment
        }

        /**
         * Assign a ticket to a user
         */
        public async assignTicket(id: string, params: {
    assigneeId: string
}): Promise<Ticket> {
            // Now make the actual call to the API
         ...
         * Create a new ticket
         */
        public async createTicket(params: CreateTicketRequest): Promise<Ticket> {
            // Now make the actual call to the API
         ...
         * Delete a ticket
         */
        public async deleteTicket(id: string): Promise<{
    success: boolean
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/tickets/${encodeURIComponent(id)}`)
    ...
    success: boolean
        ...
        public async getTicket(id: string): Promise<Ticket> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/tickets/${encodeURIComponent(id)}`)
            return await resp.json() as Ticket
        }

        public async getTicketComments(id: string): Promise<GetCommentsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/tickets/${encodeURIComponent(id)}/comments`)
    ...
    limit?: number
            ...
            const query = makeRecord<string, string | string[]>({
                ...
                urgency:    params.urgency === undefined ? undefined : String(params.urgency),
            })

            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/tickets`, undefined, {query})
            return await resp.json() as TicketListResponse
        }

        /**
         * Update a ticket
         */
        public async updateTicket(id: string, params: {
    title?: string
    description?: string
    status?: TicketStatus
    urgency?: Urgency
    ...
    dueDate?: string
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PUT", `/tickets/${encodeURIComponent(id)}`, JSON.stringify(params))
            return await resp.json() as Ticket
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "conductor-ee92-Generated-TS-Client (Encore/v1.48.10)";
        }
