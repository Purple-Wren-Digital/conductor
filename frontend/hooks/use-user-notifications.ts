...
// TODO:
// ERROR - use-user-notifications.ts:48 Failed to fetch user notification preferences SyntaxError: Failed to execute 'json' on 'Response': Unexpected end of JSON input
