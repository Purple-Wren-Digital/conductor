...
vi.mock("next/navigation", () => ({
  ...
  usePathname: () =>
    "/dashboard/template-customization/mc-austin/ticket_created/email",
}));
...
describe("EmailTemplateEditor", () => {
  ...
  describe("Form Display", () => {
    ...
    it("should display visible fields section", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByRole("checkbox", { name: /ticket number/i })
        ).toBeInTheDocument();
        expect(
          screen.getByRole("checkbox", { name: /creator name/i })
        ).toBeInTheDocument();
      });
    });
    ...
    it("should populate form with default values when no customization exists", async () => {
      ...
      await waitFor(() => {
        ...
        const greetingInput = screen.getByLabelText(
          /greeting/i
        ) as HTMLInputElement;
        const buttonInput = screen.getByLabelText(
          /button text/i
        ) as HTMLInputElement;
    ...
    it("should show correct visible fields checkboxes as checked", async () => {
      ...
      await waitFor(() => {
        ...
        const ticketNumberCheckbox = screen.getByRole("checkbox", {
          name: /ticket number/i,
        });
        const creatorNameCheckbox = screen.getByRole("checkbox", {
          name: /creator name/i,
        });
        const createdOnCheckbox = screen.getByRole("checkbox", {
          name: /created on/i,
        });
  ...
  describe("Variable Insertion", () => {
    ...
    it("should insert variable into subject field", async () => {
      ...
      await waitFor(() => {
        expect((subjectInput as HTMLInputElement).value).toContain(
          "{{ticket_title}}"
        );
      });
    });
    ...
    it("should insert variable into greeting field", async () => {
      ...
      await waitFor(() => {
        expect((greetingInput as HTMLInputElement).value).toContain(
          "{{user_name}}"
        );
      });
    });
    ...
    it("should have variable section for main message", async () => {
      ...
      await waitFor(() => {
        ...
        const mainMessageSection = screen
          .getByText(/main message/i)
          .closest("div");
  ...
  describe("Visible Fields", () => {
    ...
    it("should allow multiple fields to be selected", async () => {
      ...
      const urgencyCheckbox = screen.getByRole("checkbox", {
        name: /urgency/i,
      });
      const dueDateCheckbox = screen.getByRole("checkbox", {
        name: /due date/i,
      });
    ...
    it("should show field descriptions", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/fields to show in email/i)
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Button Text", () => {
    ...
    it("should show helper text about optional button", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/leave empty to hide button/i)
        ).toBeInTheDocument();
      });
    });
  ...
  describe("Preview Functionality", () => {
    ...
    it("should display preview modal with substituted variables", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/austin office: login issue/i)
        ).toBeInTheDocument();
  ...
  describe("Structured Editor (Mad Libs Style)", () => {
    ...
    it("should show helpful descriptions for each section", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/how to greet the recipient/i)
        ).toBeInTheDocument();
      });
    });
